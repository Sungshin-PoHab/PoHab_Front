...
function ApplyStatus(props) {
  ...
  return (
      <div className='party-div'>
        <h1 className='party-h1'>{ applyData.party } </h1>
        <h4 className='apply-h4'>지원 현황</h4>

        <h4 className='department-h4'>부서</h4>
        <div className='de-step-div'>
      ...
      <div>
        <h4 className='department-h4'>지원 인원</h4>
          현재 <p className='applicant-p'>{ applyData.applicantNum }</p>명이 지원 중이에요!  <p className='competition-p'>경쟁률 { applyData.competition } : 1</p>

        <div style={{ height: '3px'}}></div>
        <h4 className='department-h4'>지원 목록</h4>
          지원 순서로 정렬됩니다.
